...
use crate::{
    core::types::TaskId,
    scheduler::context::{ctx_get_running_task_id, ctx_get_worker_id, ctx_set_running_task, ctx_unset_running_task},
    TaskRef,
};
...
impl TaskContext {
    /// Get the engine id of the currently executing task. Usage of this outside runtime causes panic.
    pub fn engine_id() -> u8 {
        ctx_get_worker_id().engine_id()
    }
